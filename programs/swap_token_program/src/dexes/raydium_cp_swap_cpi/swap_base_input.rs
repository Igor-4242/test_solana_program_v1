// stolen from https://github.com/raydium-io/raydium-cpi-example/blob/anchor-0.31.0/cpmm-cpi/programs/cpmm-cpi/src/instructions/proxy_swap_base_input.rs
...
impl<'info> TryFrom<common::SwapBaseInput<'info>> for SwapBaseInput<'info> {
    ...
    fn try_from(
        value: common::SwapBaseInput<'info>,
